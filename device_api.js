...
export async function fetchData() {
    ...
    try {
        ...
        var apiUrl = `/items/devices`;
        var filters = {
            'filter[id][_eq]': obj.device
        };
        var fields = 'id,name,zone_id.floor_id.image,x_position,y_position,device_model_id.icon,zone_id.name,zone_id.floor_id.name,zone_id.floor_id.building_id.name,zone_id.floor_id.building_id.project_id.name,zone_id.floor_id.image';
